...
public class ProjeControllerClassName {
    ...
    void dil_click(ActionEvent event) {
    	...
    	System.out.print(i);
  	    if(i==0) {
  		  //Turkcesi Buraya
  		  kuladi_lbl.setText("Kullan�c� Ad�");
  		  sifre_lbl.setText("�ifre");
  		  giris_btn.setText("Giri�");
  		  kayitol_btn.setText("Kay�t Ol");
  		  kayitolma_btn.setText("Kay�t Olmadam Devam Et");
  		  dil.setText("Dil");
  		  dil.setText("EN");
  		  i=1;
    ...
    System.out.println(txt_sifre.getText());
    	...
    	try {
    		...
    		if(i==0){
				alert.setTitle("sayfa giri�");
				alert.setHeaderText("hata mesaj�");
				alert.setContentText("hatal� giri�");
			}
			if(i==1){
				alert.setTitle(Api.translate("tr", "en","sayfa giri�");
				alert.setHeaderText(Api.translate("tr", "en","hata mesaj�");
				alert.setContentText(Api.translate("tr", "en","hatal� giri�");
			}
